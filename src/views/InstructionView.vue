    ...
    <div class="mx-auto lg:py-16">
      <ol>
        <li class="mb-10 ms-6">
          ...
          >
            Cadastre-se para começar a trocar cartas. É rápido e fácil!
          </p>
        </li>
        <li class="mb-10 ms-6">
          <span
          ...
          <p
            class="mb-8 text-lg font-normal text-justify text-gray-500 lg:text-regular dark:text-gray-400"
          >
            Escolha as cartas que você possui da nossa vasta coleção para mostrar aos outros
            jogadores o que está disponível para troca.
          </p>
        </li>
        <li class="mb-10 ms-6">
          <span
          ...
          <h3 class="text-lg font-bold text-justify text-gray-900 lg:text-regular dark:text-white">
            Abertura de Solicitação de Troca
          </h3>
          <p
            class="mb-8 text-lg font-normal text-justify text-gray-500 lg:text-regular dark:text-gray-400"
          >
