<template>
  <div
    class="flex w-full mt-24 justify-start mx-autotext-sm font-medium gap-5 text-gray-500 dark:text-gray-400 md:me-4 mb-4 md:mb-0"
  >
    <button
      href="#"
      class="inline-flex items-center px-4 py-3 text-white bg-purple-700 rounded-lg dark:bg-purple-700"
      aria-current="page"
    >
      <svg
    ...
    <button
      href="#"
      class="inline-flex items-center px-4 py-3 text-white bg-gray-700 rounded-lg dark:bg-gray-700"
      aria-current="page"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
  ...
  <CardList :content="dataCards" />
  <TradeList :content="dataTrades" />
</template>
<script>
import CardList from '@/components/sections/CardListSection.vue'
import TradeList from './TradeListSection.vue'
      ...
      dataCards: [
        {
          ...
          cards: [
            ...
            },
            {
              ...
              description: 'Nome do Card 3'
            },
            {
              title: 'Título do Card 4',
              description: 'Nome do Card 4'
            }
          ]
        }
      ],
