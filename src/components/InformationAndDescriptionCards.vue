    ...
    <div>
      <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
        <div class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12 mb-8">
          ...
          <h1 class="text-gray-900 dark:text-white text-3xl md:text-5xl font-extrabold mb-2">{{ content[0].title }}</h1>
          <p class="text-lg font-normal text-gray-500 dark:text-gray-400 mb-6">{{ content[0].description }}</p>
        ...
        <div class="grid md:grid-cols-3 gap-8">
          <div v-for="(card, cardIndex) in content[0].cards" :key="cardIndex" class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12">
            ...
            <h2 class="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">{{ card.title }}</h2>
            <p class="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">{{ card.description }}</p>
