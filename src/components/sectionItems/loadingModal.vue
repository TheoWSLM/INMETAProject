...
<div id="static-modal" data-modal-backdrop="static" tabindex="-1" aria-hidden="false" class=" overflow-y-auto  fixed flex z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
