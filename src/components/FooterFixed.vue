...
<template>
<footer class=" rounded-lg shadow absolute w-full z-20 bottom-0 start-0">
    <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        ...
        <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">2024, feito por Theo Weber</span>
    </div>
</footer>
